...
<html lang="es">
  ...
  <body>
          ...
          <div class="demo-content">
            <div id="notification-header">
              <div style="position:relative">
                <button id="notification-icon" name="button"  class="dropbtn"><span id="notification-count"><?php if(isset($count) && $count>0) { echo $count; } ?></span><img src="img/icono.png" /></button>
    ...
    <script type="text/javascript">
     ...
     //Con esta funcion se hara la peticion ajax y traera todas las
     //notificaciones cuyo estado es igual a1
     ...
     function template(data){
       var dataMain = data.split('=');
       for(var i =0;i<dataMain.length;i++){
           cadena +=  dataMain[i];
          // content.innerHTML = dataMain   
       }
     ...
     var boton = document.getElementById('notification-icon');
     var count = document.getElementById('notification-count');
     var content  = document.getElementById('notification-latest');
     var subject =  document.getElementById('subject');
     var comment =  document.getElementById('comment');
     boton.addEventListener('click',notification);
